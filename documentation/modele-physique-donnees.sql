...
CREATE TABLE user(
        ...
        user_login            Varchar (50) NOT NULL UNIQUE /* Must be unique and valid */,
        user_password         Varchar (128) NOT NULL /* Must be valid and hashed */,
        user_email            Varchar (100) NOT NULL UNIQUE /* Must be unique and valid */,
        user_active           Boolean NOT NULL DEFAULT TRUE /* Default value TRUE, indicates if user account is active */,
        user_role             ENUM('admin', 'member') NOT NULL DEFAULT 'member' /* Assigns member role by default */, 
        user_last_login       Datetime,
        user_date_inscription Datetime NOT NULL DEFAULT CURRENT_TIMESTAMP /* By default, uses current_timestamp */
...
CREATE TABLE solar_system(
    ...
    'red_supergiant', 'blue_supergiant', 'hypergiant', 'neutron_star', 'pulsar', 'variable', 'binary', 'ternary', 'black_hole') NOT NULL  ,
        solar_system_gravity      Float NOT NULL CHECK (solar_system_gravity >= 0) /* Must be greater than or equal to 0 */  ,
        solar_system_surface_temp Float NOT NULL CHECK (solar_system_surface_temp >= 0) /* Must be greater than or equal to 0°K */  ,
        solar_system_diameter     Int NOT NULL CHECK (solar_system_diameter >= 0) /* Must be greater than or equal to 0 */  ,
        solar_system_mass         BigInt NOT NULL CHECK (solar_system_mass >= 0) /* Must be greater than or equal to 0 */  ,
        solar_system_luminosity   Int NOT NULL CHECK (solar_system_luminosity >= 0) /* Must be greater than or equal to 0 */  ,
...
CREATE TABLE planet(
        ...
        planet_gravity             Float NOT NULL CHECK (planet_gravity >= 0) /* Must be greater than or equal to 0 */  ,
        planet_surface_temp        Float NOT NULL CHECK (planet_surface_temp >= 0) /* Must be greater than or equal to 0°K */  ,
        planet_orbital_longitude   Float NOT NULL CHECK (planet_orbital_longitude >= 0 AND planet_orbital_longitude <= 360) /* Angle must be between 0 and 360°*/  ,
        planet_eccentricity        Float NOT NULL CHECK (planet_eccentricity >= 0 AND planet_eccentricity <= 1) /* Must be between 0 and 1 */ ,
        planet_apogee              Int NOT NULL CHECK (planet_apogee >= 0) /* Must be greater than or equal to 0 */  ,
        planet_perigee             Int NOT NULL CHECK (planet_perigee >= 0) /* Must be greater than or equal to 0 */  ,
        planet_orbital_inclination Int NOT NULL CHECK (planet_orbital_inclination >= 0 AND planet_orbital_inclination <= 360) /* Angle must be between 0 and 360°*/  ,
        planet_average_distance    BigInt NOT NULL CHECK (planet_average_distance >= 0) /* Must be greater than or equal to 0 */  ,
        planet_orbital_period      Int NOT NULL CHECK (planet_orbital_period >= 0) /* Must be greater than or equal to 0 */  ,
        planet_inclination_angle   Int NOT NULL CHECK (planet_inclination_angle >= 0 AND planet_inclination_angle <= 360) /* Angle must be between 0 and 360°*/  ,
        planet_rotation_period     Int NOT NULL CHECK (planet_rotation_period >= 0) /* Must be greater than or equal to 0 */  ,
        planet_mass                BigInt NOT NULL CHECK (planet_mass >= 0) /* Must be greater than or equal to 0 */  ,
        planet_diameter            Int NOT NULL CHECK (planet_diameter >= 0) /* Must be greater than or equal to 0 */  ,
        planet_rings               Int NOT NULL CHECK (planet_rings >= 0) /* Must be greater than or equal to 0 */  ,
...
CREATE TABLE moon(
        ...
        moon_gravity             Float NOT NULL CHECK (moon_gravity >= 0) /* Must be greater than or equal to 0 */  ,
        moon_surface_temp        Float NOT NULL CHECK (moon_surface_temp >= 0) /* Must be greater than or equal to 0°K */  ,
        moon_orbital_longitude   Float NOT NULL CHECK (moon_orbital_longitude >= 0 AND moon_orbital_longitude <= 360) /* Angle must be between 0 and 360°*/  ,
        moon_eccentricity        Float NOT NULL CHECK (moon_eccentricity >= 0 AND moon_eccentricity <= 1) /* Must be between 0 and 1 */ ,
        moon_apogee              Int NOT NULL CHECK (moon_apogee >= 0) /* Must be greater than or equal to 0 */  ,
        moon_perigee             Int NOT NULL CHECK (moon_perigee >= 0) /* Must be greater than or equal to 0 */  ,
        moon_orbital_inclination Int NOT NULL CHECK (moon_orbital_inclination >= 0 AND moon_orbital_inclination <= 360) /* Angle must be between 0 and 360°*/  ,
        moon_average_distance    BigInt NOT NULL CHECK (moon_average_distance >= 0) /* Must be greater than or equal to 0 */  ,
        moon_orbital_period      Int NOT NULL CHECK (moon_orbital_period >= 0) /* Must be greater than or equal to 0 */  ,
        moon_inclination_angle   Int NOT NULL CHECK (moon_inclination_angle >= 0 AND moon_inclination_angle <= 360) /* Angle must be between 0 and 360°*/  ,
        moon_rotation_period     Int NOT NULL CHECK (moon_rotation_period >= 0) /* Must be greater than or equal to 0 */  ,
        moon_mass                BigInt NOT NULL CHECK (moon_mass >= 0) /* Must be greater than or equal to 0 */  ,
        moon_diameter            Int NOT NULL CHECK (moon_diameter >= 0) /* Must be greater than or equal to 0 */  ,
        moon_rings               Int NOT NULL CHECK (moon_rings >= 0) /* Must be greater than or equal to 0 */  ,
